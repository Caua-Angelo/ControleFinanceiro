...
export default function Layout() {
    return (
        <div className="min-h-screen w-full flex bg-gradient-to-b from-slate-100 via-slate-100 via-[65%] to-[#5F9EA0]">
            ...
            <div className="flex flex-col flex-1">
                ...
                {/* Header */}
                <header className="h-[60px]   flex items-center justify-center backdrop-blur-sm">
