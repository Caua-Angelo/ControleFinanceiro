...
namespace ControleFinanceiro.API.Controllers
{
    ...
    {
        private readonly ITransacaoService _feriasService;

        public FeriasController(ITransacaoService feriasService)
        {
        ...
        #endregion
        public async Task<ActionResult<UsuarioConsultarDTO>> ConsultarFeriasPorId(int id)
        {
        ...
        #region Documentacao
        [SwaggerOperation(
        Summary = "Consulta todos as férias de um Usuario",
         Description = @"
        ...
        #endregion
        public async Task<ActionResult<UsuarioConsultarDTO>> ConsultarFeriasPorColaborador(int id)
        {
            var feriasColaborador = await _feriasService.ConsultarFeriasPorColaborador(id);
            return Ok(new ApiResponse<IEnumerable<FeriasConsultarDTO>>
            {
                StatusCode = 200,
                Mensagem = "Férias do Usuario consultadas com sucesso.",
                Data = feriasColaborador
            });
        }
        ...
        - colaboradorId: Id do Usuario a ser vinculado
